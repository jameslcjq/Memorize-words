...
const loopOptions: LoopWordTimesOption[] = [1, 2, 3, 4, 5]
                  ...
                  >
                    {loopOptions.map((value, index) => (
                      <div className="flex w-full items-center" key={value}>
                        ...
                        <label
                          className="flex-1 cursor-pointer pl-[15px] text-[15px] leading-none text-gray-900 dark:text-white dark:text-opacity-60"
                          htmlFor={`r${index}`}
                          onClick={() => onChangeLoopTimes(value)}
                        >
                          {value}
