...
export default function WordPanel() {
  ...
  const isTypingMode = exerciseMode === 'typing'
  ...
  return (
    <div className="container flex h-full w-full flex-col items-center justify-center">
      <div className="container flex h-24 w-full shrink-0 grow-0 justify-between px-12 pt-4 lg:pt-10">
          ...
          <div className="relative flex w-full justify-center">
            ...
            <div className="relative w-full">
              {isTypingMode ? (
                ...
                <QuizPanel word={currentWord} allWords={state.chapterData.words} onFinish={onFinish} key={wordComponentKey} />
              )}
            </div>
          </div>
        )}
