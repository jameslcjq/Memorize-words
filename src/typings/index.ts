...
export type InfoPanelType = 'donate' | 'community' | 'redBook'
...
export type ExerciseMode = 'typing' | 'word-to-trans' | 'trans-to-word' | 'speller' | 'dictation' | 'crossword' | 'smartLearning'
